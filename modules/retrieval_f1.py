...
def compute_retrieval_f1(collection_name: str, eval_data: list, embedding_model: str, top_k: int = 10):
    """
    Berechnet Retrieval-F1 für eine einzelne Collection.
    """
    retrieved_contexts = []
    gold_contexts = []
